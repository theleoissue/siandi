...
export default function Layout({ user, viewAsRole, onChangeViewAsRole, onKeluar }) {
  const menu = MENU_BY_ROLE[user.peran_sistem] ?? []

  return (
    <div className="flex min-h-screen" style={{ backgroundColor: '#F4F6F8', color: '#1A2634' }}>
      <Sidebar menu={menu} jumlahPersonel={user.jumlahPersonel} jumlahSprin={user.jumlahSprin} />
